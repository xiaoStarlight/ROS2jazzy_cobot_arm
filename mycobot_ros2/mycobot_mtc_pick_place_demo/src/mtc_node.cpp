  ...
  : Node("mtc_node", options)
{
  ...
  //要抓取物体的位置参数
  declare_parameter("object_pose", std::vector<double>{0.22, 0.12, 0.0+0.975, 0.0, 0.0, 0.0}, "Initial pose of the object [x, y, z, roll, pitch, yaw]");
  ...
  //放置抓取后物体要放位置
  declare_parameter("place_pose", std::vector<double>{-0.183, -0.14, 0.0+0.975, 0.0, 0.0, 0.0}, "Pose where the object should be placed [x, y, z, roll, pitch, yaw]");
